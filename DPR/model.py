...
class DPR(pl.LightningModule):
    def __init__(self, args):
        ...
        self.tanh = nn.Tanh()
        self.rank_loss = ContrastiveLoss(scale=1.0, similarity_fct=dot_product)
        self.args = args
    ...
    def training_step(self, data, batch_idx):
        ...
        # Compute loss #
        loss = self.rank_loss(cls_query, cls_pos_passages)
    ...
    def configure_optimizers(self):
        ...
        warmup_steps = int( self.args.warmup_steps * self.trainer.estimated_stepping_batches )
        print("Estimated stepping batches is {}".format(self.trainer.estimated_stepping_batches), flush=True)
